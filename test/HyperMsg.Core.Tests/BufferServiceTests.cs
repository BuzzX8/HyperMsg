...
namespace HyperMsg
{
    public class BufferServiceTests : ServiceHostFixture
    {
        ...
        public void SendWriteToBufferCommand_Invokes_FlushCommand_Handler()
        {
            ...
            HandlersRegistry.RegisterFlushBufferReader(BufferType.Transmitting, bufferReader);
        ...
        public void SendWriteToBufferCommand_Writes_Stream_Content_To_Buffer()
        {
            ...
            HandlersRegistry.RegisterFlushBufferSegmentReader(BufferType.Receiving, buffer =>
            {
        ...
        public void SendFlushBufferCommand_Invokes_Handler_Registered_By_RegisterFlushBufferCommandHandler()
        {
            ...
            HandlersRegistry.RegisterFlushBufferSegmentReader(BufferType.Transmitting, buffer =>
            {
                actual = buffer.ToArray();
                return (int)buffer.Length;
            });
